...
Replace all {{PLACEHOLDER}} values with your information:
  idrisiser     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  idrisiser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/idrisiser/security/advisories/new)
...
- This repository (`hyperpolymath/idrisiser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/idrisiser/security/advisories)
...
When using idrisiser, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/idrisiser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/idrisiser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/idrisiser/discussions) |
...
*Thank you for helping keep idrisiser and its users safe.* 🛡️
