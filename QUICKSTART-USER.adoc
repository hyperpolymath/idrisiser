...
// Replace idrisiser, Idrisiser — See README.adoc for details., just run, Idrisiser started successfully. with actuals
= idrisiser — Quick Start for Users
:toc:
:toclevels: 2

== What is idrisiser?

Idrisiser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./idrisiser-portable
----
...
[source]
----
Idrisiser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/idrisiser/wiki
